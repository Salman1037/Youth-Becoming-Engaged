...
const slides = [
  {
    title: "Youth Becoming Engaged Organization",
    text:
      "Youth Becoming Engaged Organization supports young people through mentoring, case management, and community-based programs. We work with families, schools, and local leaders to provide educational support, health-focused learning, and positive engagement opportunities that help youth build confidence, life skills, and a stronger future within their communities. Our goal is to guide young people toward positive choices and long-term personal success.",
    btns: [
      { label: "Learn About Our Programs", href: "/programs" },
      { label: "Get Involved", href: "/get-involved" },
    ],
  ...
  },
  {
    title: "Empowering Youth Through Support",
    text:
      "We provide mentorship, learning resources, and guidance that help young people succeed in school, improve confidence, and develop positive habits. Our programs focus on emotional well-being, personal growth, and leadership development so that youth can overcome challenges and move forward with purpose and motivation. We also support young people in discovering their strengths and planning their future goals.",
    btns: [
      { label: "Our Mission & Vision", href: "/mission" },
      { label: "Become a Volunteer", href: "/volunteer" },
    ],
  ...
  },
  {
    title: "Building Strong Youth Communities",
    text:
      "By working with community partners and families, we help create safe and supportive spaces where young people can grow, learn, and stay engaged in positive activities. Our programs encourage teamwork, leadership, and community involvement while helping youth build practical skills for a better future. Together, we strengthen connections between youth, families, and local organizations.",
    btns: [
      { label: "Partner With Our Organization", href: "/partners" },
      { label: "Connect With Our Team", href: "/contact" },
    ],
